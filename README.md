<div align="center">
  <h1 align="center"><a href="https://github.com/hmbrg/prisma-issue">prisma-issue</a></h1>
  <p align="center"><strong>Find digital solutions for agricultural businesses. — transparent. independently. free.</strong></p>
</div>
<p align="center">
  <a aria-label="Build" href="https://github.com/hmbrg/prisma-issue/actions?query=workflow%3ACI">
    <img alt="build" src="https://img.shields.io/github/workflow/status/prisma-issue/prisma-issue/CI-web-app/main?label=CI&logo=github&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="Codefactor grade" href=https://www.codefactor.io/repository/github/prisma-issue/prisma-issue">
    <img alt="Codefactor" src="https://img.shields.io/codefactor/grade/github/prisma-issue/prisma-issue?label=Codefactor&logo=codefactor&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="CodeClimate maintainability" href="https://codeclimate.com/github/prisma-issue/prisma-issue">
    <img alt="Maintainability" src="https://img.shields.io/codeclimate/maintainability/prisma-issue/prisma-issue?label=Maintainability&logo=code-climate&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="CodeClimate technical debt" href="https://codeclimate.com/github/prisma-issue/prisma-issue">
    <img alt="Techdebt" src="https://img.shields.io/codeclimate/tech-debt/prisma-issue/prisma-issue?label=TechDebt&logo=code-climate&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="Codacy grade" href="https://www.codacy.com/gh/prisma-issue/prisma-issue/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=prisma-issue/prisma-issue&amp;utm_campaign=Badge_Grade">
    <img alt="Codacy grade" src="https://img.shields.io/codacy/grade/dff9c944af284a0fad4e165eb1727467?logo=codacy&style=flat-square&labelColor=000&label=Codacy">
  </a>
  <a aria-label="LoC">  
    <img alt="LoC" src="https://img.shields.io/tokei/lines/github/prisma-issue/prisma-issue?style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="Top language" href="https://github.com/hmbrg/prisma-issue/search?l=typescript">
    <img alt="GitHub top language" src="https://img.shields.io/github/languages/top/prisma-issue/prisma-issue?style=flat-square&labelColor=000&color=blue">
  </a>
  <a aria-label="Licence" href="https://github.com/hmbrg/prisma-issue/blob/main/LICENSE">
    <img alt="Licence" src="https://img.shields.io/github/license/prisma-issue/prisma-issue?style=flat-quare&labelColor=000000" />
  </a>
</p>
...
- [apps/web-app](./apps/web-app): SSR, i18n, GraphQL, Rest. [README](./apps/web-app/README.md) | [DEMO/Vercel](https://prisma-issue-web-app.vercel.app) | [CHANGELOG](./apps/web-app/CHANGELOG.md)
- [apps/blog-app](./apps/blog-app): SSG. [README](./apps/blog-app/README.md) | [DEMO/Vercel](https://prisma-issue-blog-app.vercel.app) | [CHANGELOG](./apps/blog-app/CHANGELOG.md)
...
"scripts": {
  ...
  "postinstall": "test -n \"$SKIP_POSTINSTALL\" || yarn workspace @prisma-issue/db-main-prisma run prisma generate"
},
```
...
```json5
{
  "name": "@prisma-issue/magnificent-poney",
  "version": "0.0.0",
  "private": true,
  "scripts": {
...
```bash
cd apps/my-app
yarn add @prisma-issue/magnificent-poney@'workspace:*'
```
...
```json5
{
  "name": "my-app",
  "dependencies": {
    "@prisma-issue/magnificient-poney": "workspace:*",
  },
}
```
...
```json5
{
  "compilerOptions": {
    ...
    "paths": {
      ...
      "@prisma-issue/magnificent-poney/*": [
...
>   graph dependencies.
> - The **star** in `@prisma-issue/magnificent-poney/*` allows you to import subfolders. If you use
...
The packages are now linked to your app, just import them like regular packages: `import { poney } from '@prisma-issue/magnificent-poney'`.
...
```json5
{
  "scripts": {
    ...
    "packages:build": "yarn workspaces foreach -ptv --include '@prisma-issue/*' run build",
    "packages:lint": "yarn workspaces foreach -ptv --include '@prisma-issue/*' run lint",
    "packages:typecheck": "yarn workspaces foreach -ptv --include '@prisma-issue/*' run typecheck",
    "packages:clean": "yarn workspaces foreach -ptv --include '@prisma-issue/*' run clean",
...
[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2Fprisma-issue%2Fprisma-issue.svg?type=large)](https://app.fossa.com/projects/git%2Bgithub.com%2Fprisma-issue%2Fprisma-issue?ref=badge_large)
